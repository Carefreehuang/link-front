    ...
    <el-skeleton :loading="props.loading" animated class="posts-skeleton">
      ...
      <template #default>
        <table class="post-table">
          <tbody class="post-tbody">
            <tr v-for="post of props.posts" :key="post.id" class="posts">
              ...
              <td class="post-title">
                <router-link :to="{ name: 'viewPost', params: { pid: post.id } }" v-text="post.title"
              ...
              <td class="view-and-reply">
                <el-tooltip content="点赞量" placement="top" :show-after="600">
                  <span class="like hidden-xs-only">
                    <i class="czs-heart-l">&nbsp;</i>
                    <router-link :to="{ path: '/p/' + post.id }" v-text="post.likeNumber" />
                  </span>
                </el-tooltip>
        ...
        <el-pagination class="pagination"
          ...
          layout="prev, pager, jumper, next, ->, total" small background :total="props.totalItems"
          :page-count="props.totalPage" :pager-count="5" :current-page="props.currentPage"
...
.pagination .el-pagination__goto,
.pagination .el-pagination__classifier {
  display: none !important;
}
